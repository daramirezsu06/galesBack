...
export class PaymentTermrs1729113241061 implements MigrationInterface {
    name = 'PaymentTermrs1729113241061'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_customer_type_enum" AS ENUM('retail', 'wholesaler', 'Employe')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."orders_payment_terms_enum"`);
